...
export function SideNavbar() {
  ...
  /* Object Template
    ...
    <li>
      <div id={} classItem="sidebar-list-item">
              <div className="sidebar-list-item-inner">
                ...
                <div className="sidebar-list-item-inner-count">
                  {countAllTasks > 0 && countAllTasks}
                </div>
              </div>
            </div>
    </li>
  ...
  */
  ...
  /*
    ...
    TODO:
    do the same thing for the Tasklist Click
  */
        ...
        <ul className="sidebar-lists">
          {sideBarMenu.map((menu) => (
            <li
              id={menu.id}
              // className={
              //   activeId === menu.id ? "sidebar-list-item-active" : "sidebar-list-item-inactive"
              // }
            >
          ...
          {/* <li>
            <div id="myday" classItem="sidebar-list-item">
              <div className="sidebar-list-item-inner">
                ...
                <div className="sidebar-list-item-inner-count">
                  {countOngoingTasks > 0 && countOngoingTasks}
                </div>
              </div>
            </div>
          </li> */}
          ...
          {/* <li>
            <div id="important" classItem="sidebar-list-item">
              <div className="sidebar-list-item-inner">
                ...
                <div className="sidebar-list-item-inner-count">
                  {countFavoriteTasks > 0 && countFavoriteTasks}
                </div>
              </div>
            </div>
          </li> */}
