...
export function Task({ task }) {
  ...
  // different svg checkmark styling based on state of task (complete, uncomplete -> hovered/unhovered)
  function svgIconComplete() {
    if (task.complete) {
    ...
    <div className={`task-container`} onClick={handleClick}>
      ...
      >
        ...
        >
          ...
          >
            <path d={svgIconComplete()} fill="#2564cf"></path>
          </svg>
        </span>
